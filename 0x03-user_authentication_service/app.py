#!/usr/bin/env python3
""" Basic Flask app setup, User Registration, Login, Logout, User profile,
    Get reset passwords token, Password Update end-point """
...
def login() -> str:
    ...
    Email and password fields in x-www-form-urlencoded request
    Return:
      - JSON payload
    """
